...
public class TUserDaoImpl implements TUserDao{
    ...
    public void updateTUser(TUser tuser) {
        final String sql = "update TUser set iud=:tuserIud, nom=:tuserIud, prenom=:tuserPrenom, email=:tuserEmail, entite=:tuserEntite, ismanager=:tuserIsManager, emailmanager=:tuserEmailManager, isadmin=:tuserIsAdmin, accesauxchaines=:tuserAccesAuxChaines, serveurunix=:tuserServeurUnix, loginunix=:tuserLoginUnix, datedecreation=:tuserDateDeCreation, auteurcreation=:tuserAuteurCreation, datedemodification=:tuserDateDeModification, auteurdemodification=:tuserAuteurDeModification, refmyaccess=:tuserRefMyAccess";
